...
class arithmeticExpression{
  ...
  public:
    ...
    /* Calls the recursive infix function. starts at root node*/
    void infix();

    /* Calls the recursive prefix function. starts at root node*/
    void prefix();

    /* Calls the recursive postfix function. starts at root node */
    void postfix();
